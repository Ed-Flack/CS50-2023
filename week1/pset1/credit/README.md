# The 'Credit' assignment of Problem Set 1 of Harvard's CS50

Comprised of two C files, credit-tidy.c - a tidier solution to the problem, and credit-faster.c - a faster solution to the problem, both utlising the CS50 library.
...
1. For the sake of discussion, let’s first underline every other digit, starting with the number’s second-to-last digit:</br>
  <ins>4</ins>0<ins>0</ins>3<ins>6</ins>0<ins>0</ins>0<ins>0</ins>0<ins>0</ins>0<ins>0</ins>0<ins>1</ins>4</br>
...
2. Now let’s add that sum (13) to the sum of the digits that weren’t multiplied by 2 (starting from the end):</br>
